...
public final class ActivityHandler extends Handler {
	...
	ActivityHandler(Activity activity, Collection<BarcodeFormat> decodeFormats, Map<DecodeHintType, ?> baseHints,
		...
		decodeThread = new DecodeThread(cameraManager, decodeFormats, baseHints, characterSet,
				mCallBack.getViewfinderResultPointCallback(), this);
		decodeThread.start();
		state = State.SUCCESS;
	 ...
	 */
	static interface IScanListener {
